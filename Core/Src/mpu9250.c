...
static void
MPU9250_ReadReg(MPU9250_Handle* hmpu, uint8_t reg, uint8_t* data, uint8_t len) {
...
void MPU9250_InitMagnetometer(MPU9250_Handle* hmpu) {
    ...
    MPU9250_WriteReg(hmpu, AK8963_I2C_SLV0_ADDR, (AK8963_ADDRESS << 1) | 0x01); // I2C_SLV0_ADDR (read)
